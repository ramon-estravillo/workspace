...
public class ReasonPhraseTest {
    ...
    public void valueOf_shouldReturnHttpStatusMessage_whenValueExist() {
        assertEquals("Bad Request", ReasonPhrase.valueOf(400));
    }

    @Test
    @DisplayName("Should return error code message when value exist")
    public void valueOf_shouldReturnErrorCodeMessage_whenValueExist() {
    ...
    public void valueOf_shouldThrowNoSuchMessageException_whenValueDoesNotExist() {
