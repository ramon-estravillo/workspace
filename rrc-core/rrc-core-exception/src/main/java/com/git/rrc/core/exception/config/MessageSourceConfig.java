 ...
 * <ul>
 *     <li>{@code message/source/appl/messages.properties} for application error codes</li>
 *     <li>{@code message/source/http/messages.properties} for HTTP status codes</li>
 * </ul>
 * </p>
 *
 * <p>
...
public class MessageSourceConfig {
     ...
     *
     * @return a configured {@link ResourceBundleMessageSource} using {@code message/source/appl/messages} as its base name
     */
    ...
    public MessageSource errorCodeReasonPhrase() {
        ...
        resourceBundleMessageSource.setBasenames("message/source/appl/messages");
     ...
     *
     * @return a configured {@link ResourceBundleMessageSource} using {@code message/source/http/messages} as its base name
     */
    @Bean(name = "httpStatusReasonPhrase")
    public MessageSource httpStatusReasonPhrase() {
        ResourceBundleMessageSource resourceBundleMessageSource = resourceBundleMessageSource();
        resourceBundleMessageSource.setBasenames("message/source/http/messages");
        return resourceBundleMessageSource;
    }
